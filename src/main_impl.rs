...
impl TextRange {
    ...
    // Convert from usize to u16 for convenience when creating ranges
...
pub mod message_modifier {
    ...
    /// # Examples
    /// ```
    /// use ssbc::message_modifier::SipMessageModifier;
    /// use std::net::SocketAddr;
    /// 
...
pub mod message_builder {
    ...
    /// ```
    /// use ssbc::message_builder::SipMessageBuilder;
    /// use ssbc::Method;
    /// 
...
a=rtpmap:0 PCMU/8000\r\n";
    ...
    // Run basic benchmark
    // crate::benchmark::benchmark_sip_parsing();

    // Run the comprehensive benchmarks
    crate::benchmark::run_comprehensive_benchmark();
}
